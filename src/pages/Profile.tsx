      ...
      <form className="w-full max-w-sm mt-2 ">
        <div className="md:flex md:items-center mb-2 bg-field mb-2">
          ...
          <div className="md:w-2/3 h-12">
            <input
              className="appearance-none rounded w-full py-2 px-4 text-white leading-tight text-base"
              type="text"
        ...
        <div className="md:flex md:items-center bg-field mb-2">
          <div className="md:w-1/3">
          ...
          <div className="md:w-2/3 h-12">
            <input
              className="appearance-none rounded w-full py-2 px-4 text-white leading-tight text-base focus:outline-none active:outline-none"
              type="text"
              placeholder="JDmedia"
              value={username}
            />
        ...
        <div className="md:flex md:items-center bg-field">
          ...
          <div className="w-2/3 h-12">
            <input
              className="appearance-none rounded w-full text-white leading-tight text-base"
              type="text"
