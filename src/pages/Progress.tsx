...
import darker from '../commons/arrow-darker.svg'
...
export const Progress: React.FC = () => {
 ...
 const chevronDown = <img src={arrow} className="h-4 mt-1 pr-2" />
 const chevronRight = <img src={right} className="h-5 pt-1 pr-2" />
 ...
 return (
  <div className="bg-field ml-8 mr-8 mt-6 pb-2 mb-4">
   ...
   >
    ...
    <img src={job} className="h-4 ml-2" />
   </button>
   {toggle && (
